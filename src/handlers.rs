...
use crate::models::{User, LoginRequest, RegisterRequest, AuthResponse, Claims};
use crate::AppState;

pub async fn root() -> &'static str {
    "Welcome to the login system with PostgreSQL!"
}
...
pub async fn dashboard(
    ...
    Ok(Json(AuthResponse {
        message: format!("Dashboard for user {} (ID: {})", claims.username, claims.sub),
        token: None,
    }))
}